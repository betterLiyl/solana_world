...
describe('close-an-account', () => {
  ...
  it('Create Account', async () => {
    ...
    const userAccountInfo = await program.account.userState.getAccountInfo(userAccountAddress);
    console.log("User accountAddr:" + userAccountAddress);
    console.log("userAccountInfo:" + JSON.stringify(userAccountInfo));
...
//   });
  //998.59428184 SOL - 1496400/10 0000 0000
  //998.59278044 SOL
  //998.59427184 SOL
});
